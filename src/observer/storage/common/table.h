...
public:
    ...
    RC create_index(Trx *trx, const char *index_name, char *const attribute_names[], int len, int unique);
    RC update_record(const char *attribute_name, const Value *value, Record *record);
    //新增的函数，用于隐藏列
